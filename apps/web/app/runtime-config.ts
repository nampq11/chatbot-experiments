import type { FetchApiDataOptions } from "@chatbot-experiments/client/api";

function trimTrailingSlashes(value: string): string {
  return value.replace(/\/+$/, "");
}

export const AI_API_BASE_URL = trimTrailingSlashes(
...
export const APP_BASE_URL = trimTrailingSlashes(
...
export function createServerApiFetchOptions(
  revalidate: number = API_REVALIDATE_SECONDS,
): FetchApiDataOptions {
  return {
