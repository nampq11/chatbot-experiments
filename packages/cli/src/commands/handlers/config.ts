...
export function printConfig(env: CliEnv, version: string, verbose = false): void {
  output.write("\x1b[1m\x1b[36mDentalTrip AI Configuration\x1b[0m\n\n");
  ...
  output.write(`\x1b[1mDATABASE_URL\x1b[0m  ${maskSensitive(env.databaseUrl)}\n`);
  output.write(`\x1b[1mCORS_ORIGIN\x1b[0m  ${formatCorsOrigins(env.corsOrigins)}\n`);
