...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: the sidebar open state must persist across reloads in browsers without the Cookie Store API.
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-40 hidden h-dvh w-[var(--sidebar-width)] md:flex",
          side === "left"
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "group-data-[collapsible=icon]:hidden mx-2 w-auto",
        className,
      )}
      {...props}
    />
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  const scrollRef = useScrollVisible<HTMLDivElement>();
